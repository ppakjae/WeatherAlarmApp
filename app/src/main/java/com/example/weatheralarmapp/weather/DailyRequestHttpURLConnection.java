...
public class DailyRequestHttpURLConnection {
    URL url = null;
    HttpURLConnection httpURLConnection = null;

    ContentValues values = null;

    static final String REQUEST_LOCATION_URL_HOURLY = "https://apis.openapi.sk.com/weather/current/hourly?";    //해당 시간 업뎃
    static final String APP_KEY = "21ba537b-98d5-4ac0-ae6e-7f8cdf80af64";
    String params = "";

    public DailyRequestHttpURLConnection(ContentValues reqLocation){
...
//        String lon = (String) reqLocation.get("lon");
        ...
        try{
            url = new URL(REQUEST_LOCATION_URL_HOURLY+params);
